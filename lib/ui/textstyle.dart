...
class TextStyles {
  ...
  static const timerNameTextStyle = TextStyle(height: 2, fontSize: 25,fontWeight: FontWeight.w600,letterSpacing: 0.1);
  ...
  static const maintimerStyle = TextStyle(height: 2, fontSize: 25,fontWeight: FontWeight.w600,letterSpacing: 0.1, color: ColorStyles.greytext);
